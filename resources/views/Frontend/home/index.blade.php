        ...
        <div id="carouselExampleIndicators" class="carousel slide">
            ...
            <div class="carousel-i">
              <div class="slick-slider">
                        ...
                        <div class="slide-box-1 text-center center">
                            <div class="avtar-img">
                            <img src="{{asset('assets/images/place.png')}}" class="b-radius">
                            </div>
                        ...
                        <div class="slide-box-1  text-center right ">
                            ...
                            <h5 class="mt-2">Silvia D</h5>
                            <p>Customer</p>
                            <div class="quote-img">
                                <img src="{{asset('assets/images/quote-line.png')}}">
                            </div>
                            <p  class="fs-14">
                            Punctual and polite. Deone and Troy are the absolute best. The only rideshare/ car service that I have used since discovering them. Clean cars and lovely service. 10 out of 10, would recommend :)
                            </p>
                        </div> 
                </div>
            </div>
