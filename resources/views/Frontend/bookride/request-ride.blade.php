        ...
        <div class="container-fluid px-lg-5 px-2">
            ...
            <div class="col-lg-12">
                <div class="r-heading mt-lg-3 mt-5 mb-5">
                    ...
                    <p>Here is where you book a ride! Book one for yourself or choose the option below to Book for Someone. 
                        <!-- <a href="{{route('request-ride-someone')}}" class="orange text-link text-decoration-underline"> Book for Someone</a>  -->
                    </p>
                </div>
            </div>
                    ...
                    <div class="col-md-8">
                        <form action="{{route('request-ride')}}" method="post" id="book_ride">
                            ...
                            <div class="book-your-ride h-100 p-4">
                                ...
                                <a class="btn btn-book w-100 py-3  fw-500 bg-black text-white px-lg-5 rounded-15 book-else" href="{{route('request-ride-someone')}}">Book for Someone Else</a>
                                </p>
                                </div>
                                {{-- <div class="input-row "> --}}
                                    <div class="row ">
                                        ...
                                        <div class="date-input d-flex gap-3 mb-3">
                                            ...
                                            <div class="d-input" aria-label="date" aria-describedby="addon-wrapping">
                                                <input type="text" id="date_time" name="ride_date" class="form-control bg-trans rounded-15 @error('ride_date') is-invalid @enderror" aria-label="date" aria-describedby="addon-wrapping" autocomplete="off" value="{{ old('date_time') }}" placeholder="Date &amp; time">
                                                <div class="d-icon">
                                        ...
                                        <div class="form-group col-md-6">
                                        <div class="pick-up-input mb-lg-4 mb-3">
                                        ...
                                        <div class="bk-rd-fare-btn text-end mt-3">
                                            <button class="btn btn-book w-50 py-3  fw-500 bg-black text-white px-lg-5 rounded-15" type="submit">Book Ride Now</button>
                                        </div>
                                    </div>
                                {{-- </div> --}}
                            </div>
...
<script>
    ...
    //             let selectedTime = $input.val();  // Get the value after selecting time
    //             console.log('Selected date and time: ', selectedTime);
    //             $input.val(selectedTime);  // Ensure the input field gets updated correctly
    //         },
