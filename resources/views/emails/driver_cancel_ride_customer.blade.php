...
<div class="container">
    <div class="header">
        ...
        <h2>Ride Canceled</h2>
        <p>We're sorry, but your ride has been canceled by the driver.</p>
    </div>

    <div class="content">
        <p>Dear <strong>{{ $booking->user->first_name }} {{ $booking->user->last_name }}</strong>,</p>
        <p>We regret to inform you that your scheduled ride has been canceled by the driver. Please find the details below:</p>
        ...
        <p>We apologize for the inconvenience. You can book a new ride using the button below:</p>

        <div style="text-align: center;">
            <a href="{{ url('/book-ride') }}" class="btn">Book a New Ride</a>
        </div>

        <p class="support">For any assistance, please contact support at <a href="mailto:info@troyrides.com">info@troyrides.com</a></p>
    </div>
