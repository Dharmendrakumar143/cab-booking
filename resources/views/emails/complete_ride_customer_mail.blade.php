...
<head>
    ...
    <title>Ride Completed - #BK{{ $booking->id }}</title>
    <style>
        body {
...
<div class="container">
    ...
    <div class="content">
        ...
        <div style="text-align: center; margin-top: 20px;">
            <a href="{{ url('/view-trip-details/'.$booking->rideRequests->id) }}" class="btn" style="margin-right: 10px; padding: 10px 20px; background-color: #4CAF50; color: white; text-decoration: none; border-radius: 5px;">Rate Your Ride</a>
            <a href="{{ url('/tip/driver-tip/'.encrypt($booking->id)) }}" class="btn" style="padding: 10px 20px; background-color: #FB980F; color: #000000; text-decoration: none; border-radius: 5px;">Tip For Driver</a>
        </div>
