...
<head>
    ...
    <title>Ride Cancellation - #BK{{ $booking->id }}</title>
    <style>
        body {
...
<div class="container">
    <div class="header">
        ...
        <p>Your ride booking has been successfully canceled.</p>
    </div>

    <div class="content">
        <p>Dear <strong>{{ $booking->admin->first_name }} {{ $booking->admin->last_name }}</strong>,</p>
        <p>You have canceled a ride. Here are the details of the canceled booking:</p>
        <table>
            <tr>
        ...
        <p class="support">If you canceled by mistake or need assistance, please contact support at <a href="mailto:info@troyrides.com">info@troyrides.com</a></p>
    </div>
