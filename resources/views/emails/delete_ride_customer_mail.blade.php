...
<div class="container">
    <div class="header">
        ...
        <h2>Ride Deleted</h2>
        <p>Your ride has been deleted by the admin.</p>
    </div>

    <div class="content">
        <p>Dear <strong>{{ $booking->user->first_name }} {{ $booking->user->last_name }}</strong>,</p>
        <p>We would like to inform you that your scheduled ride has been deleted by our admin team. Please find the ride details below:</p>
        ...
        <p>We apologize for the inconvenience caused. You can easily book another ride by clicking the button below:</p>

        <div style="text-align: center;">
            <a href="{{ url('/') }}" class="btn">Book a New Ride</a>
        </div>

        <p class="support">Need help? Reach out to us at <a href="mailto:info@troyrides.com">info@troyrides.com</a></p>
    </div>
