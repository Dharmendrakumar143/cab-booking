...
<div class="container">
    <div class="header">
        ...
        <h2>Ride Started</h2>
        <p>Your ride is now in progress!</p>
    </div>

    <div class="content">
        <p>Dear <strong>{{ $booking->user->first_name }} {{ $booking->user->last_name }}</strong>,</p>
        <p>Your driver has started the ride. Below are the details of your booking:</p>
        ...
        <table>
            ...
            <tr>
                ...
                <td>{{ $booking->admin->car_model }} - {{ $booking->admin->car_number_plate }}</td>
            </tr>
            <tr>
