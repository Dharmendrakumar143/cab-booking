...
<div class="content-pm-info">
    ...
    <div class="content-page-box">
        <h6 class="color-23 fw-600 mb-3">Page</h6>
        <form action="{{ route('update-faq') }}" method="POST" id="update_faq_question">
            @csrf
            ...
            <div class="content-page-form shadow rounded-20 p-lg-5 p-3 col-lg-12">
                <div class="col-md-12">
                    <div class="c-title-input mb-3">
                        ...
                        <textarea class="form-control rounded-30 bg-f6 @error('question') is-invalid @enderror" id="question" name="question">
                            {{$faq->question}}
                        </textarea>
                    </div>
                    @error('question')
                ...
                <div class="col-md-12">
                    <div class="c-title-input">
                        ...
                        <textarea class="form-control rounded-30 bg-f6 @error('answer') is-invalid @enderror" id="answer" name="answer">
                        {{$faq->answer}}
                        </textarea>
                    </div>
                    @error('answer')
                ...
                <div class="col-md-12 mt-3">
                    <div class="c-title-input">
                        ...
                        <select class="form-control rounded-30 bg-f6 @error('question_type') is-invalid @enderror" id="question_type" name="question_type">
                                ...
                                <option value="general questions" {{ isset($faq->question_type) && $faq->question_type == 'general questions' ? 'selected' : '' }}>General Questions</option>
                                <option value="account and booking questions" {{ isset($faq->question_type) && $faq->question_type == 'account and booking questions' ? 'selected' : '' }}>Account and Booking Questions</option>
                                <option value="service and safety questions" {{ isset($faq->question_type) && $faq->question_type == 'service and safety questions' ? 'selected' : '' }}>Service and Safety Questions</option>
                                <option value="support questions" {{ isset($faq->question_type) && $faq->question_type == 'support questions' ? 'selected' : '' }}>Support Questions</option>
