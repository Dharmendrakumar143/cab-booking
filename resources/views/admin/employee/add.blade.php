...
<div class="content-pm-info">
    <div class="content-page-box mt-4">
        <h4 class="color-23 fw-600 mb-3">Add New Employee</h4>
        <form action="{{route('store-employee')}}" method="POST" id="add-employee">
            @csrf
            <div class="content-page-form shadow rounded-20 p-lg-5 p-3 col-lg-12">
                <div class="col-md-12">
                    <div class="c-title-input mb-3">
                        ...
                        <input type="text" class="form-control rounded-30 bg-f6 @error('first_name') is-invalid @enderror" id="first_name" name="first_name">
                    </div>
                    @error('first_name')
                ...
                <div class="col-md-12">
                    <div class="c-title-input mb-3">
                        ...
                        <input type="text" class="form-control rounded-30 bg-f6 @error('last_name') is-invalid @enderror" id="last_name" name="last_name">
                    </div>
                    @error('last_name')
                        <div class="invalid-feedback">{{$message}}</div>
                    @enderror
                ...
                <div class="col-md-12">
                    <div class="c-title-input mb-3">
                        ...
                        <input type="text" class="form-control rounded-30 bg-f6 @error('phone_number') is-invalid @enderror" id="phone_number" name="phone_number">
                    </div>
                    @error('phone_number')
                        <div class="invalid-feedback">{{$message}}</div>
                    @enderror
                ...
                <div class="col-md-12">
                    <div class="c-title-input mb-3">
                        ...
                        <input type="text" class="form-control rounded-30 bg-f6 @error('email') is-invalid @enderror" id="email" name="email">
                    </div>
                    @error('email')
                        <div class="invalid-feedback">{{$message}}</div>
                    @enderror
                ...
                <div class="col-md-12">
                    <div class="c-title-input mb-3">
                        ...
                        <input type="password" class="form-control rounded-30 bg-f6 @error('password') is-invalid @enderror" id="password" name="password">
                    </div>
                    @error('password')
                        <div class="invalid-feedback">{{$message}}</div>
                    @enderror
