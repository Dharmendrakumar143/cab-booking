...
@section('content')
<div class="payment-success-table custom-table mt-5 mb-4">
    <div class="passe-heading ">
...
<div class="payment-success-box">
    <div class="row">
        <div class="col-md-11">
            ...
            <div class="col-md-6">
                <div class="payment-passenger-details mb-3">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="bg-black rounded-20 pt-3">
                                <div class="fr-detls gray-bg rounded-20 p-4">
                                    <div class="fare-header d-flex justify-content-between flex-wrap mb-3">
                                        <h4>Passanger Details</h4>
                                    </div>
                                    <div class="base-fare-box bg-light-gray d-flex justify-content-between rounded-8 p-2 mb-3">
                                        <p>Mobile</p> <p class="fw-500"><span class="pe-3">:</span> {{$payment_detail->users->phone_number}}</p>
                                    </div>
                                    <div class="base-fare-box bg-light-gray d-flex justify-content-between rounded-8 p-2 mb-3">
                                        <p>Email id</p> <p class="fw-500"><span class="pe-3">:</span> {{$payment_detail->users->email}}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="book-bg h-auto">
                <div class="drver-details text-white">
                    ...
                    <div class="l-plate">
                        <p class="fw-500 fs-14"><span class="pe-3">:</span> {{$payment_detail->booking->admin->name ?? null}}</p>
