...
<div class="content-pm-info">
    ...
    <div class="content-page-box">
        ...
        <form action="{{ route('pages.update') }}" method="POST">
            ...
            <div class="content-page-form shadow rounded-20 p-lg-5 p-3 col-lg-8">
                <div class="col-md-12">
                ...
                <div class="col-md-12">
                    <div class="c-title-input">
                        ...
                        <input type="text" class="form-control rounded-30 bg-f6 @error('page_slug') is-invalid @enderror" id="page_slug" name="page_slug" value="{{$page->slug}}">
                ...
                <!-- <div class="col-md-12">
                    <div class="c-title-input">
                        <label for="image" class="form-label fw-600">Image</label>
                        <input type="file" class="form-control rounded-30 bg-f6" id="image" name="image">
                    </div>
                </div> -->
