...
class DriverForgotPasswordService
{
    /**
     ...
     */
    public function forgotDriverPassword($request)
    {
        try {
            ...
            $resetLink = url('/driver/reset-password/' . $resetToken);
     ...
     *               - 'message' (string): Provides details about the operation result.
     */
    public function resetDriverPassword($request)
    {
        try {
